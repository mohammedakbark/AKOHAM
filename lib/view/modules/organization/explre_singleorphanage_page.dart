...
class _ExploreSingleOrphanagePageOrganizationState
  ...
  Widget build(BuildContext context) {
    Provider.of<FireStore>(context,listen: false).getSelectedOrphanageData(widget.orphId);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image:  DecorationImage(
                              fit: BoxFit.fill,
                              image:data?.image==""?imageNotFound: NetworkImage(
                                "${data?.image}"
                              ))),
                      child: Column(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Column(
                                  children: [
                                    customeText(
                                        text: "${data?.childCount}", textcolor: blue, size: 30),
                                    customeText(
                                        text: "Children",
                                        textcolor: grey600,
                                        size: 15),
                  ...
                  InkWell(
                    onTap: () {
                      Get.to(ChildListPageOrganization(childcount: data?.childCount,));
                    },
                    child: Container(
                      height: hight * .06,
                      width: width,
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  customeText(text: "${data?.contactNumber}", size: 16),
                              ...
                              Column(
                                ...
                                children: [
                                 customeText(text: bankData?.bank, size: 16),
                                  customeText(text: "${bankData?.accountNumber}", size: 16),
                                  customeText(text:  "${bankData?.epaymentnumber}", size: 16),
                                  customeText(text:  "${bankData?.contactNumber}", size: 16),
                                ],
                              )
                            ],
                          ),

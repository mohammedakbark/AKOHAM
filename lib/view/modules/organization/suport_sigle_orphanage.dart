...
class SupportSingleOrphanagePafeOrganization extends StatefulWidget {
  dynamic selectedOrphnID;
  SupportSingleOrphanagePafeOrganization(
      {super.key, required this.selectedOrphnID});

  @override
  State<SupportSingleOrphanagePafeOrganization> createState() =>
      _SupportSingleOrphanagePafeOrganizationState();
}

class _SupportSingleOrphanagePafeOrganizationState
    extends State<SupportSingleOrphanagePafeOrganization> {
  bool isExpanded = false;
  bool isSupporting = false;
  @override
  Widget build(BuildContext context) {
    Provider.of<FireStore>(context, listen: false)
        .getSelectedOrphanageData(widget.selectedOrphnID);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                      ...
                      child: customeText(
                          text: data?.orphnName, size: 22, textcolor: grey600)),
                  Container(
                      width: width * .9,
                      height: hight * .25,

              ...
              child: Column(
                ...
                children: [
                    ...
                    onTap: () {
                      storeInstence.addSupportOrphanageInIndividual(
                          ...
                          SupportingOrphanModel(
                              contactNumber: "${orphnData?.contactNumber}",
                              isSupporting: "true",
                              image: "${orphnData?.image}",
                              location: "${orphnData?.location}",
                              name: "${orphnData?.orphnName}",
                              numberOfChild: "${orphnData?.contactNumber}"));
                  ...
                  InkWell(
                    onTap: () {
                      Get.to(ChildListPageIndividual(
                        childcount: firestore.orphnRegModel?.childCount,
                      ));
                    },
                    child: Container(
                      height: hight * .06,
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  customeText(
                                      ...
                                      size: 16),
                                  customeText(
                                      text: "${orphnData?.email}", size: 16),
                                  customeText(
                                      text: "${orphnData?.location}", size: 16),
                                ],
                              )
                            ],
                          ),

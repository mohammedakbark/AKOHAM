...
class AdoptionRequestedUserProfileOrphanage extends StatelessWidget {
  ...
  Provider.of<FireStore>(context, listen: false)
        .fechSingleChildAllData(childInd);
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                children: [
                                  ...
                                  Column(
                                      ...
                                      children: [
                                        ...
                                        customeText(
                                            text: userType == "Individual"
                                                ? firestore.indivRegModel!.email
                                                : firestore.orgnRegModel!.email,
                                            size: 16),
                                        customeText(
                                            text: userType == "Individual"
                                                ? firestore
                          ...
                          easyButton(
                            ...
                            textcolor: grey600,
                            bgColor: const MaterialStatePropertyAll(white),
                          ),
                          const Gap(30),
                        ],
                      ),
                              ...
                              child: Container(
                                ...
                                child: ListTile(
                                  leading: Container(
                                    decoration: BoxDecoration(
                                        image: DecorationImage(
                                            image: firestore.childDataRegModel
                                                        ?.image ==
                                                    ""
                                                ? imageNotFound
                                                : NetworkImage(
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          customeText(
                                              text: firestore
                                                  .childDataRegModel?.name,
                                              textcolor: grey600),
                                          customeText(
                                              text: firestore
                                                  .childDataRegModel?.age
                                                  .toString(),
                                              textcolor: grey600),
                                          customeText(
                                              text: firestore
                                                  .childDataRegModel?.gender,
                                              textcolor: grey600)
                                        ],
                                      )
                                    ],
